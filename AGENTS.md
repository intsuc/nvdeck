...
Before delivering the UI, inspect every screen and component against all applicable gates in order. Do not finish until every applicable gate passes. When an existing UI system is present, verify that every remaining custom element or style is limited to
